...
public class CreateIntrebareTest {
    ...
    public void test4() throws InputValidationFailedException, DuplicateIntrebareException {
        ...
        Intrebare intrebare = new Intrebare("Asdfhgg", "1)Zece", "2)Unspe", "2", "Matematica");
        ctrl.addNewIntrebare(intrebare);
    }
    ...
    public void test5() throws InputValidationFailedException, DuplicateIntrebareException {
        ...
        Intrebare intrebare = new Intrebare("Asdfrysfuhergherhgreiihdugfejhewfukhrghefjkfgrefgyfedjfruedkfjgtyriekdjfgtruiejdfhgurdkjfhurfdkjchrjdfgurjdhturfjgturifkjgurufjghtuirfjkvhgturkedjhgtrrffkjghtjrfklmghtuirfkdcghtuirfkdfmghtuiroedklmfgturioedlkjghturioepdlkjhgturiedlkjghturiedlkjhgtu?", "zece", "unspe", "doi", "Matematica");
        ctrl.addNewIntrebare(intrebare);
    }
}